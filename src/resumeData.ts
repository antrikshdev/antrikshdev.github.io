export const resumeData = {
  "basics": {
    ...
    "summary": "Highly accomplished IT professional with a decade of experience, excelled in large private organizations such as Microsoft, GlobalLogic, and Thomson Digital. Developed expertise in Azure Cloud DevOps, microservices with a focus on Docker and containerization, and Infrastructure solutions. Adept in Microsoft Azure DevOps services like Pipelines, Release pipelines, and Azure DevOps Board, along with a solid understanding of orchestration tools such as Kubernetes. Proficient in Microsoft Azure policies, Key Vault, and Container Insights. Extensive expertise in building and pushing Docker images to ACR. Possesses in-depth knowledge of Azure services, with a specific focus on Azure Kubernetes Service, Azure Container Registry, and Azure Container Instances. Equipped with cutting-edge skills in open-source tools like IAC Terra-form and version control (Git), enabling the delivery of effective solutions and exceptional support to valued customers.",
  ...
  "certifications": [
    "Azure Containers - Azure Red Hat OpenShift - Specialist Assessment Certificate",
