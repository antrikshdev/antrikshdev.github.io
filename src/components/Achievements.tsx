  ...
  return (
    <section className="py-32 px-6 bg-white/[0.02]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-white mb-6">Impact & Achievements</h2>
          <p className="text-white/40 max-w-2xl mx-auto">Measurable results and key milestones achieved throughout my career.</p>
        </motion.div>
          ...
          {resumeData.achievements.map((ach, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="mb-6 inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-white/10 text-white">
                  <Award size={24} />
                </div>
                ...
                <p className="text-white/50 leading-relaxed">{ach.context}</p>
              </div>
